...
import { Shield, ShieldAlert, Navigation, Phone, Users } from 'lucide-react-native';
...
export default function PanicScreen() {
  ...
  useEffect(() => {
    // Animación de respiración del botón central
    Animated.loop(
      Animated.sequence([
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {/* BOTÓN DE PÁNICO CENTRAL DE ALTO IMPACTO */}
      <View style={styles.centerContainer}>
        <Animated.View style={{ transform: [{ scale: pulseAnim }] }}>
          <TouchableOpacity 
            activeOpacity={0.85} 
            onPress={() => setIsActive(!isActive)}
            style={[styles.panicButtonOuter, isActive ? styles.panicButtonAlertOuter : styles.panicButtonNormalOuter]}
          >
            <View style={[styles.panicButtonInner, isActive ? styles.panicButtonAlertInner : styles.panicButtonNormalInner]}>
              {isActive ? (
                <ShieldAlert size={56} color="#FFFFFF" />
              ) : (
                <Shield size={56} color="#FFFFFF" />
              )}
              <Text style={styles.panicButtonText}>{isActive ? 'CANCELAR' : 'PÁNICO'}</Text>
              <Text style={styles.panicButtonSubtext}>
                {isActive ? 'Mantén presionado para cancelar' : 'Presiona 3 seg o doble toque'}
              </Text>
            </View>
          </TouchableOpacity>
        </Animated.View>
        <View style={[styles.glowShadow, isActive ? styles.glowShadowAlert : styles.glowShadowNormal]} />
      </View>
        ...
        <View style={styles.companionSection}>
          <View style={styles.companionHeader}>
            ...
            <TouchableOpacity 
              ...
              style={[styles.toggleContainer, isCompanionActive ? styles.toggleActive : styles.toggleInactive]}
            >
              <View style={[styles.toggleCircle, isCompanionActive ? styles.toggleCircleActive : styles.toggleCircleInactive]} />
            </TouchableOpacity>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  backgroundGradient: { position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: '#08090c' },
  header: { alignItems: 'center', marginTop: 40, paddingHorizontal: 24 },
  statusIndicator: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(19, 21, 26, 0.75)', paddingVertical: 10, paddingHorizontal: 16, borderRadius: 99, borderWidth: 1, borderColor: 'rgba(255, 255, 255, 0.08)' },
  gpsContainer: { width: 14, height: 14, justifyContent: 'center', alignItems: 'center', marginRight: 8 },
  gpsDot: { width: 8, height: 8, borderRadius: 4, backgroundColor: '#10b981' },
  gpsDotAlert: { backgroundColor: '#ff2a5f' },
  radarWave: { position: 'absolute', width: 14, height: 14, borderRadius: 7, backgroundColor: 'rgba(16, 185, 129, 0.4)' },
  statusText: { color: '#ffffff', fontSize: 13, fontWeight: '600' },
  statusSuccessHighlight: { color: '#10b981', fontWeight: '700' },
  statusAlertHighlight: { color: '#ff2a5f', fontWeight: '700' },
  locationSubtitle: { color: '#9ca3af', fontSize: 12, marginTop: 6, letterSpacing: 0.5, textTransform: 'uppercase' },
  centerContainer: { flex: 1, justifyContent: 'center', alignItems: 'center', position: 'relative' },
  panicButtonOuter: { width: 250, height: 250, borderRadius: 125, padding: 10, justifyContent: 'center', alignItems: 'center', zIndex: 2 },
  panicButtonNormalOuter: { backgroundColor: 'rgba(255, 42, 95, 0.08)', borderWidth: 1.5, borderColor: 'rgba(255, 42, 95, 0.25)' },
  panicButtonAlertOuter: { backgroundColor: 'rgba(255, 94, 58, 0.15)', borderWidth: 1.5, borderColor: 'rgba(255, 94, 58, 0.4)' },
  panicButtonInner: { width: '100%', height: '100%', borderRadius: 120, justifyContent: 'center', alignItems: 'center' },
  panicButtonNormalInner: { backgroundColor: '#ff2a5f' },
  panicButtonAlertInner: { backgroundColor: '#ff3a30' },
  panicButtonText: { color: '#ffffff', fontSize: 28, fontWeight: '900', letterSpacing: 1.5, marginTop: 12 },
  panicButtonSubtext: { color: 'rgba(255, 255, 255, 0.75)', fontSize: 11, textAlign: 'center', paddingHorizontal: 20, marginTop: 6 },
  glowShadow: { position: 'absolute', width: 230, height: 230, borderRadius: 115, zIndex: 1, opacity: 0.5 },
  glowShadowNormal: { backgroundColor: '#ff2a5f', shadowColor: '#ff2a5f', shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.8, shadowRadius: 40 },
  glowShadowAlert: { backgroundColor: '#ff5e3a', shadowColor: '#ff5e3a', shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.9, shadowRadius: 50 },
  bottomCard: { backgroundColor: 'rgba(19, 21, 26, 0.85)', borderRadius: 28, borderWidth: 1, borderColor: 'rgba(255, 255, 255, 0.08)', padding: 20, marginHorizontal: 16, marginBottom: 30 },
  companionSection: { paddingBottom: 4 },
  companionHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  companionTitleContainer: { flexDirection: 'row', alignItems: 'center', flex: 1 },
  companionIconBox: { width: 40, height: 40, borderRadius: 12, backgroundColor: 'rgba(255, 42, 95, 0.1)', justifyContent: 'center', alignItems: 'center', marginRight: 12 },
  companionTitle: { color: '#ffffff', fontSize: 16, fontWeight: '700' },
  companionSubtitle: { color: '#9ca3af', fontSize: 11, marginTop: 2 },
  toggleContainer: { width: 50, height: 28, borderRadius: 14, padding: 3, justifyContent: 'center' },
  toggleActive: { backgroundColor: '#10b981' },
  toggleInactive: { backgroundColor: 'rgba(255, 255, 255, 0.1)' },
  toggleCircle: { width: 22, height: 22, borderRadius: 11, backgroundColor: '#ffffff' },
  ...
  contactsRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  contactItem: { alignItems: 'center', width: 60 },
  avatarContainer: { width: 44, height: 44, borderRadius: 22, backgroundColor: 'rgba(255, 255, 255, 0.05)', borderWidth: 1, borderColor: 'rgba(255, 255, 255, 0.1)', justifyContent: 'center', alignItems: 'center', position: 'relative' },
  avatarText: { color: '#ffffff', fontSize: 13, fontWeight: '600' },
  activeContactDot: { position: 'absolute', bottom: 1, right: 1, width: 10, height: 10, borderRadius: 5, backgroundColor: '#10b981', borderWidth: 1.5, borderColor: '#13151a' },
  contactName: { color: '#9ca3af', fontSize: 11, marginTop: 6, textAlign: 'center' },
  addContactButton: { alignItems: 'center', justifyContent: 'center', width: 68, height: 68, borderRadius: 16, backgroundColor: 'rgba(255, 255, 255, 0.03)', borderWidth: 1, borderColor: 'rgba(255, 255, 255, 0.06)', borderStyle: 'dashed' },
  addContactText: { color: '#9ca3af', fontSize: 10, marginTop: 4, textAlign: 'center' }
});`;
